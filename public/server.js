...
// Corrige __dirname no formato ES Modules
...
app.get("/adminn/admin.html", (req, res) => {
  res.sendFile(path.join(__dirname, "adminn", "admin.html"));
});
...
// ===================== RELATÓRIO =====================
app.get("/adminn/relatorio.html", (req, res) => {
  res.sendFile(path.join(__dirname, "adminn", "relatorio.html"));
});
